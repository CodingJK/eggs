...
@section('content')
	...
	<div class="recipes">
		...
		<div class="col-xs-12 header text-center">
			...
			<p class='title_body'>
					特別鳴謝Manitoba Egg Farmers www.eggs.mb.ca/ 提供食譜
			...
			<div class="col-xs-12 recipe_details text-center">
				...
				<div class="step">
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">在中型平底鍋用中火燒熱油。加入洋蔥，炒5-7分鐘至軟熟。加入蒜頭和紅辣椒，炒1分鐘至香味散發。
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">加入番茄、牛至和胡椒粉，慢火煮5-10分鐘至醬汁濃稠。熄火，拌入新鮮香草和菲達芝士。芝士糊倒入8×8吋(20×20厘米)的烤盤中。
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">用匙羹在芝士糊壓四個洞，打入雞蛋。
					...
					<div class="steps col-xs-12  text-center">
						...
						<div class="col-xs-10 col-xs-offset-1 step_body">放入已經預熱的焗爐中，焗12-15分鐘直至醬汁起泡，雞蛋凝固即成。可供4人食用。
