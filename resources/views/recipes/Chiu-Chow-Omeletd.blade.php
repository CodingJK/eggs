...
@section('content')
	...
	<div class="recipes">
		...
		<div class="col-xs-12 header text-center">
			...
			<span class='recipe_title'>潮式煎蠔餅</span>
			<p class='title_body'>
					以中國南部的一個城市命名，這是一款適合您全家享用的特色菜品。蠔粒令煎蛋餅相當美味可口。
			</p>
		...
		<div class="container-fuild recipes_images">
			...
			<div class="col-xs-12 ">
				<img src="/images/recipes/Eggs-SA-26-Final-large.jpg" alt="">
			</div>
			...
			<div class="col-xs-12  text-center desc">
				<ul class='container-fuild text-center'>
					...
					<li class='recipe_worlds'>準備時間: 12分鐘</li>
					<li><img src="/images/icons/soup-icon.png" alt=""></li>
					<li class='recipe_worlds'>烹調時間: 5-7分鐘</li>
				</ul>
			</div>
