...
@section('content')
	...
	<div id='apps'>
      	<div class='header col-xs-12'  style="margin-bottom: 65px;">
	    ...
	    <div class='timer_parent'>
	    	...
	    	<div class='timer'>
	    		...
	    		<div class='timer_title' style='font-family: Noto Sans TC;margin:80px; color:#333; '>
	    			煮蛋計時App
	    		</div>
	    		...
	    		<div class='timer_title' style='font-weight:bold;font-family: Noto Sans TC; margin-top:20px;font-size:40px;'>
