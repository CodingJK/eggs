...
<body>
    <nav class="navbar navbar-fixed-top">
        <div class="container">
            <div class="myHead">
                ...
                <div class='links'>
                    <a href="https://sc.eggsaregood.ca">主頁</a>
                    <a href="https://www.eggsaregood.ca/contest" style='font-family: "Noto Sans TC", sans-serif !important; '>繁體中文</a>
                </div>
            </div>
            <!--/.nav-collapse -->
        </div>
    ...
    <div class="container-fluid title">
        <div class="container">
            ...
            <form method="POST" action="/savePic_sc" id='myForm' enctype="multipart/form-data">
